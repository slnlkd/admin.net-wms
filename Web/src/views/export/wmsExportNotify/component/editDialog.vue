			...
			<el-form :model="state.ruleForm" ref="ruleFormRef" label-width="auto" :rules="rules">
				<el-row :gutter="35">
					<el-form-item v-show="false">
						...
						<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20" >
						<el-form-item label="执行标志（0待执行、1正在分配、 2正在执行、3已完成、5已上传） 4作废" prop="exportExecuteFlag">
							<el-input-number v-model="state.ruleForm.exportExecuteFlag" placeholder="请输入执行标志（0待执行、1正在分配、 2正在执行、3已完成、5已上传） 4作废" clearable />
						</el-form-item>
					</el-col>
						<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20" >
