...
const handleQuery = async (params: any = {}) => {
  state.tableQueryParams.ReportType=1;
  ...
  <div class="wmsBaseBillType-container" v-loading="state.exportLoading">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="统计时间">
               <el-date-picker type="year" v-model="state.tableQueryParams.startDate" format="YYYY年" value-format="YYYY"
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item >
              <el-button-group style="display: flex; align-items: center;">
                <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'wmsAnnualReport:page'" v-reclick="1000"> 查询 </el-button>
                ...
                <el-dropdown :show-timeout="70" :hide-timeout="50" @command="exportWmsReportChartsCommand">
                  <el-button type="primary" style="margin-left:5px;" icon="TrendCharts" v-reclick="20000" v-auth="'wmsAnnualReport:chart'"> 图表 </el-button>
                  <template #dropdown>
                    <el-dropdown-menu>
                ...
                <el-dropdown :show-timeout="70" :hide-timeout="50" @command="exportWmsBaseBillTypeCommand">
                  <el-button type="primary" style="margin-left:5px;" icon="ele-FolderOpened" v-reclick="20000" v-auth="'wmsAnnualReport:export'"> 导出 </el-button>
                  <template #dropdown>
                    <el-dropdown-menu>
    ...
    <el-card class="full-table" v-show="state.tableShow" shadow="hover" style="margin-top: 5px">
      <el-table :data="state.tableData" @selection-change="(val: any[]) => { state.selectData = val; }" style="width: 100%" v-loading="state.tableLoading" tooltip-effect="light" row-key="id" @sort-change="sortChange" border>
        <el-table-column type="selection" width="40" align="center" v-if="auth('wmsAnnualReport:batchDelete') || auth('wmsAnnualReport:export')" />
