...
const handleQuery = async (params: any = {}) => {
  state.tableQueryParams.ReportType=2;
  ...
  <div class="wmsBaseBillType-container" v-loading="state.exportLoading">
        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item label="统计时间">
               <el-date-picker type="month" v-model="state.tableQueryParams.startDate" format="YYYY年MM月" value-format="YYYY-MM"
                      placeholder="选择年月" style="flex: 1;" />
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="state.showAdvanceQueryUI">
            <el-form-item label="物料编码">
              <el-input v-model="state.tableQueryParams.materialId" clearable placeholder="请输入物料编码"/>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10" v-if="state.showAdvanceQueryUI">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="8" :xl="4" class="mb10">
            <el-form-item >
              <el-button-group style="display: flex; align-items: center;">
                <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'wmsMonthlyReport:page'" v-reclick="1000"> 查询 </el-button>
                ...
                <el-dropdown :show-timeout="70" :hide-timeout="50" @command="exportWmsReportChartsCommand">
                  <el-button type="primary" style="margin-left:5px;" icon="TrendCharts" v-reclick="20000" v-auth="'wmsMonthlyReport:chart'"> 图表 </el-button>
                  <template #dropdown>
                    <el-dropdown-menu>
                ...
                <el-dropdown :show-timeout="70" :hide-timeout="50" @command="exportWmsBaseBillTypeCommand">
                  <el-button type="primary" style="margin-left:5px;" icon="ele-FolderOpened" v-reclick="20000" v-auth="'wmsMonthlyReport:export'"> 导出 </el-button>
                  <template #dropdown>
                    <el-dropdown-menu>
    ...
    <el-card class="full-table" v-show="state.tableShow" shadow="hover" style="margin-top: 5px">
      <el-table :data="state.tableData" @selection-change="(val: any[]) => { state.selectData = val; }" style="width: 100%" v-loading="state.tableLoading" tooltip-effect="light" row-key="id" @sort-change="sortChange" border>
        <el-table-column type="selection" width="40" align="center" v-if="auth('wmsMonthlyReport:batchDelete') || auth('wmsMonthlyReport:export')" />
