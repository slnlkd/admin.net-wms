	...
	<div class="sys-role-container">
		...
		<el-card class="full-table" shadow="hover" style="margin-top: 5px">
            ...
            <g-sys-dict v-model="scope.row.dataScope" code="DataScopeEnum" />
				...
				<el-table-column label="操作" width="340" fixed="right" align="center" show-overflow-tooltip>
					<template #default="scope">
						...
						<el-button icon="ele-Edit" size="small" text type="primary" @click="openEditQuickAction(scope.row)" v-auth="'sysRole:update'"> 编辑快捷菜单 </el-button>
		...
		<EditQuickAction ref="editQuickActionRef" :title="state.editRoleTitle" @handleQuery="handleQuery" />
...
import EditQuickAction from '/@/views/system/role/component/editQuickAction.vue';
...
const editQuickActionRef = ref<InstanceType<typeof EditQuickAction>>();
...
// 打开编辑快捷菜单页面
const openEditQuickAction = async (row: any) => {
	state.editRoleTitle = '编辑快捷菜单';
	editQuickActionRef.value?.openDialog(row);
};
