...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=1300000000241, Name="近效期预警天数", Code=ConfigConst.ValidityWaringDay, Value="30", SysFlag=YesNoEnum.Y, Remark="近效期预警天数（天）", OrderNo=1, GroupCode=ConfigConst.SysDefaultGroup, CreateTime=DateTime.Parse("2026-01-12 00:00:00") },
            new SysConfig{ Id=1300000000251, Name="复验期预警天数", Code=ConfigConst.RetestWaringDay, Value="30", SysFlag=YesNoEnum.Y, Remark="复验期预警天数（天）", OrderNo=2, GroupCode=ConfigConst.SysDefaultGroup, CreateTime=DateTime.Parse("2026-01-12 00:00:00") },
        };
    }
}