...
/// 申请供应商信息基础输入参数
/// </summary>
public class WmsBaseSupplierPresetBaseInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 申请供应商信息分页查询输入参数
/// </summary>
public class PageWmsBaseSupplierPresetInput : BasePageInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
...
/// 申请供应商信息增加输入参数
/// </summary>
public class AddWmsBaseSupplierPresetInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
    [Required(ErrorMessage = "供应商编码不能为空")]
    [MaxLength(32, ErrorMessage = "供应商编码字符长度不能超过32")]
    public string? CustomerCode { get; set; }
    ...
    /// </summary>
    [Required(ErrorMessage = "供应商名称不能为空")]
    [MaxLength(32, ErrorMessage = "供应商名称字符长度不能超过32")]
    public string? CustomerName { get; set; }
    
    /// <summary>
    /// 供应商地址
    /// </summary>
    [MaxLength(32, ErrorMessage = "供应商地址字符长度不能超过32")]
    public string? CustomerAddress { get; set; }
...
/// 申请供应商信息删除输入参数
/// </summary>
public class DeleteWmsBaseSupplierPresetInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 申请供应商信息更新输入参数
/// </summary>
public class UpdateWmsBaseSupplierPresetInput
{
    /// <summary>
    /// 主键Id
    /// </summary>    
...
/// 申请供应商信息主键查询输入参数
/// </summary>
public class QueryByIdWmsBaseSupplierPresetInput : DeleteWmsBaseSupplierPresetInput
{
}
...
public class ImportWmsBaseSupplierPresetInput : BaseImportInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
    ...
    /// 供应商地址
    /// </summary>
    [ImporterHeader(Name = "供应商地址")]
    [ExporterHeader("供应商地址", Format = "", Width = 25, IsBold = true)]
    public string? CustomerAddress { get; set; }
    ...
    /// 审核状态，0=未审核，1=通过，2=驳回
    /// </summary>
    [ImporterHeader(Name = "审核状态，0=未审核，1=通过，2=驳回")]
    [ExporterHeader("审核状态，0=未审核，1=通过，2=驳回", Format = "", Width = 25, IsBold = true)]
    public int ApprovalStatus { get; set; }
    ...
    /// 申请供应商信息审核输入参数
    /// </summary>
    public class ApprovalWmsBaseSupplierPresetInput
    {
        /// <summary>
        /// 主键Id
        /// </summary>
    ...
    /// 申请供应商信息批量审核输入参数
    /// </summary>
    public class BatchApprovalWmsBaseSupplierPresetInput
    {
        /// <summary>
        /// 主键Id列表
        /// </summary>
