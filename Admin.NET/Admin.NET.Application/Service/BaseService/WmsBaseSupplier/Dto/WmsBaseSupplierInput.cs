...
/// 供应商信息基础输入参数
/// </summary>
public class WmsBaseSupplierBaseInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 供应商信息分页查询输入参数
/// </summary>
public class PageWmsBaseSupplierInput : BasePageInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
...
/// 供应商信息增加输入参数
/// </summary>
public class AddWmsBaseSupplierInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
...
/// 供应商信息删除输入参数
/// </summary>
public class DeleteWmsBaseSupplierInput
{
    /// <summary>
    /// 主键Id
    /// </summary>
...
/// 供应商信息更新输入参数
/// </summary>
public class UpdateWmsBaseSupplierInput
{
    /// <summary>
    /// 主键Id
    /// </summary>    
...
/// 供应商信息主键查询输入参数
/// </summary>
public class QueryByIdWmsBaseSupplierInput : DeleteWmsBaseSupplierInput
{
}
...
public class ImportWmsBaseSupplierInput : BaseImportInput
{
    /// <summary>
    /// 供应商编码
    /// </summary>
