...
/// 单据类型表输出参数
/// </summary>
public class WmsBaseBillTypeOutput
{
    /// <summary>
    /// 主键Id
    /// </summary>
    ...
    /// 质检状态名称
    /// </summary>
    public string? QualityInspectionStatusName { get; set; }
...
/// 单据类型表数据导入模板实体
/// </summary>
public class ExportWmsBaseBillTypeOutput : ImportWmsBaseBillTypeInput
{
