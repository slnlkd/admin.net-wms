...
[SugarTable("WmsBaseSupplierPreset", "供应商信息预设")]
public partial class WmsBaseSupplierPreset : EntityBaseDel
{
    /// <summary>
    /// 供应商编码
    /// </summary>
    [SugarColumn(ColumnName = "CustomerCode", ColumnDescription = "供应商编码", Length = 32)]
    public virtual string? CustomerCode { get; set; }
    
    /// <summary>
    /// 供应商名称
    /// </summary>
    [SugarColumn(ColumnName = "CustomerName", ColumnDescription = "供应商名称", Length = 32)]
    public virtual string? CustomerName { get; set; }
    
    /// <summary>
    /// 供应商地址
    /// </summary>
    [SugarColumn(ColumnName = "CustomerAddress", ColumnDescription = "供应商地址", Length = 32)]
