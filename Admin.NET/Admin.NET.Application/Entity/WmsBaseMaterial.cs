...
[SugarTable("WmsBaseMaterial", "物料信息")]
public partial class WmsBaseMaterial : EntityBaseDel
{
    /// <summary>
    /// 物料编码
    /// </summary>
    ...
    /// <summary>
    /// 是否空托盘（1：是，0：非空）全局唯一 一个允许空托
    /// </summary>
    [SugarColumn(ColumnName = "IsEmpty", ColumnDescription = "是否空托盘（1：是，0：非空）全局唯一 一个允许空托")]
